...
A full list of required variables and their values can be found here - Copy and paste all the variables and their values inside your new config.env file:
**Link: https://docs.google.com/document/d/12wauGNtxjV_gk5iVCyqENEll6J2fbAUdMebQ1tSjSmY/edit?usp=sharing** 
